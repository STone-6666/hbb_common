...
lazy_static::lazy_static! {
     static ref ORG: RwLock<String> = RwLock::new("com.carriez".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    static ref ONLINE: Mutex<HashMap<String, i64>> = Default::default();
     static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("".to_owned());
     static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
     static ref APP_NAME: RwLock<String> = RwLock::new("RustDesk".to_owned());
    static ref KEY_PAIR: Mutex<Option<KeyPair>> = Default::default();
    static ref USER_DEFAULT_CONFIG: RwLock<(UserDefaultConfig, Instant)> = RwLock::new((UserDefaultConfig::load(), Instant::now()));
     static ref NEW_STORED_PEER_CONFIG: Mutex<HashSet<String>> = Default::default();
     static ref DEFAULT_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
     static ref OVERWRITE_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
     static ref DEFAULT_DISPLAY_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
     static ref OVERWRITE_DISPLAY_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
     static ref DEFAULT_LOCAL_SETTINGS: RwLock<HashMap<String, String>> = Default::default();
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.zhainima.cn"];
pub const RS_PUB_KEY: &str = "Qq@397832506";
